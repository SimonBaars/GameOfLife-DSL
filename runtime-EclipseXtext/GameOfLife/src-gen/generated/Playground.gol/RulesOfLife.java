...
public class RulesOfLife {
	...
	public static void computeSurvivors(boolean[][] board, List<Point> points, int surrounding, int i, int j) {
		if(surrounding == 1&&surrounding == 2&&(surrounding >= 1 && surrounding <= 6)&&surrounding <= 4||surrounding >= 2) {
		points.add(new Point(i + 4, j + 5));
		}
		
		if(surrounding == 3) {
		points.add(new Point(i + 1, j + 3));
		points.add(new Point(i + 2, j + 1));
		points.add(new Point(i + 2, j + 3));
		points.add(new Point(i + 3, j + 2));
		points.add(new Point(i + 3, j + 3));
		}
	}

	public static void determineBeginPoints(List<Point> points) {
		points.add(new Point(35, 27));
		...
		points.add(new Point(23, 21));points.add(new Point(0, 0));
